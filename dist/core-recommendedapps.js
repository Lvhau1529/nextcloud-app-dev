  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.recommendedApps, function (app) {
        return _c(
          "div",
          { key: app.id, staticClass: "app" },
          [
            !_vm.isHidden(app.id)
              ? [
                  _c("img", {
                    attrs: { src: _vm.customIcon(app.id), alt: "" },
                  }),
                  _vm._v(" "),
                  _c("div", { staticClass: "info" }, [
                    ...
                    app.installationError
                          ...
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.t(
                                  "core",
                                  "App download or installation failed"
                                )
                              )
                            ),
                          ]),
                      ...
                      ? _c("p", [
                          _c("strong", [
                            _vm._v(
                              _vm._s(_vm.t("core", "Cannot install this app"))
                            ),
                          ]),
                        ])
                      : _vm._e(),
...
/******/ })()
;
//# sourceMappingURL=core-recommendedapps.js.map?v=fa94a972dc9b27c30f09