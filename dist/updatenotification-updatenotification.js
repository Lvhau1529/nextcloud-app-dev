...
/* harmony import */ var vue_click_outside__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vue-click-outside */ "./node_modules/vue-click-outside/index.js");
/* harmony import */ var vue_click_outside__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(vue_click_outside__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @nextcloud/initial-state */ "./node_modules/@nextcloud/initial-state/dist/index.js");
...
/* harmony import */ var _nextcloud_logger__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @nextcloud/logger */ "./node_modules/@nextcloud/logger/dist/index.js");
...
var logger = (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_11__.getLoggerBuilder)().setApp('updatenotification').detectUser().build();
v_tooltip__WEBPACK_IMPORTED_MODULE_5__.VTooltip.options.defaultHtml = false;
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  directives: {
    ClickOutside: (vue_click_outside__WEBPACK_IMPORTED_MODULE_6___default()),
  ...
  watch: {
    ...
    isNewVersionAvailable: function isNewVersionAvailable() {
      ...
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__.generateOcsUrl)('apps/updatenotification/api/v1/applist/{newVersion}', {
  ...
  beforeMount: function beforeMount() {
    // Parse server data
    var data = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_8__.loadState)('updatenotification', 'data');
  ...
  methods: {
    searchGroup: debounce__WEBPACK_IMPORTED_MODULE_10___default()( /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__.generateOcsUrl)('cloud/groups/details'), {
                  search: query,
                  limit: 20,
                  offset: 0
                });
    ...
    clickUpdaterButton: function clickUpdaterButton() {
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__.generateUrl)('/apps/updatenotification/credentials')).then(function (_ref4) {
        var data = _ref4.data;
    ...
    changeReleaseChannel: function changeReleaseChannel(channel) {
      ...
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"].post((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__.generateUrl)('/apps/updatenotification/channel'), {
        channel: this.currentChannel
      }).then(function (_ref5) {
        var data = _ref5.data;
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_9__.showSuccess)(data.data.message);
      });
...
/******/ })()
;
//# sourceMappingURL=updatenotification-updatenotification.js.map?v=fbfe8f77c9e87756193f